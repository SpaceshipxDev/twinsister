      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 py-12">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="mb-12">
            ...
            <p className="font-['Crimson_Text'] text-xl md:text-2xl text-amber-100/90 italic">
          ...
          <div className="bg-amber-50/95 backdrop-blur-sm rounded-xl p-8 md:p-12 shadow-2xl border border-amber-200/50">
            <div className="space-y-6 text-left">
              <p className="font-['Crimson_Text'] text-lg md:text-xl text-amber-900 leading-relaxed">
              ...
              <p className="font-['Crimson_Text'] text-lg md:text-xl text-amber-900 leading-relaxed">
                ...
                Your words of courage echo in my mind when all seems lost. "All we have to decide is 
                what to do with the time that is given us" - how true those words ring now, in this 
                desolate place.
              </p>
              ...
              <p className="font-['Crimson_Text'] text-lg md:text-xl text-amber-900 leading-relaxed mb-8">
              ...
              <div className="text-right">
                ...
                <p className="font-['Crimson_Text'] text-sm text-amber-700 italic mt-1">
          ...
          <p className="font-['Crimson_Text'] text-sm text-amber-100/70 italic">
